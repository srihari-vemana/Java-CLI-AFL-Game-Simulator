...
{
    // Class variables
    private static final int[] defenderProbability = {0, 0, 0, 80, 20, 0, 0};
    private static final String position = "Defender";
    private static final int[] starDefenderProbability = {0, 0, 0, 95, 5, 0, 0};

    /**
     * Default constructor for the Defender class.
     *
     */
    public Defender()
    {
        super();
        setPlayerProbability(defenderProbability);
    }

    /**
     * Parameterised constructor for the Defender class.
     *
     ...
     */
    public Defender(String name, int seasonGoals, String teamName)
    {
    ...
    */
    ...
    public void setIsStarPlayer(boolean starStatus)
    {
        ...
        setPlayerProbability(starDefenderProbability);
    }
